import { Code2Icon, CrownIcon, LoaderIcon, SolarPanelIcon, UsersIcon, ZapIcon } from 'lucide-react'
          ...
          {isLoading? (
            <div className='flex items-center justify-center py-20'>
              ...
              sessions.map(session => (
                <div key={session._id} className='card bgbase-200 border-2 border-base-300 hover-border-primary/50'>
                   <div className='flex items-center justify-between gap-4 p-5'>
                    ...
                    <div className='flex items-center gap-4 flex-1'>
                      <div className='relative size-14 rounded-xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center'>
                        ...
                        <div className='absolute -top-1 -right-2 size-4 bg-success rounded-full border-2 border-base-100' />
                      </div>
